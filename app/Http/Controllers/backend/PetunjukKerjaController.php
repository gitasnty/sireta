...
class PetunjukKerjaController extends Controller
{
    public function view(){
    	...
    	$data=Document::where('doctype', 'Petunjuk Kerja')->get();
        return view ('backend.petunjukkerja.view_petunjukkerja', compact('data'));
    ...
    public function upload(Request $request){
        ...
        return redirect()->route('petunjukkerja.view')->with($notification);
    }

...
class ProsedurMutuController extends Controller
{
    public function view(){
    	...
    	$data=Document::where('doctype', 'Prosedur Mutu')->get();
        return view ('backend.prosedurmutu.view_prosedurmutu', compact('data'));
    ...
    public function upload(Request $request){
        ...
        return redirect()->route('prosedurmutu.view')->with($notification);
    }

...
<head>
  <meta charset="utf-8">
    ...
    <title>Sireta Admin - Registration </title>
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            ...
                            <x-jet-validation-errors style="color:aquamarine"/>
                            ...
                            @csrf
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" type="email" name="email"  class="form-control pl-15 bg-transparent text-white plc-white" :value="old('email')" placeholder="Email" required>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">

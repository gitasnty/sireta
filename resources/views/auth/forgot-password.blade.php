...
<head>
  <meta charset="utf-8">
    ...
    <title>Sireta Admin - Recover Password</title>
                            ...
                            <form method="POST" action="{{ route('password.email') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Your Email" name="email" :value="old('email')" required autofocus>
									</div>
								</div>
								  <div class="row">

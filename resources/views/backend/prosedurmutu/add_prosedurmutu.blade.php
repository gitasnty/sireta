		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Tambah Dokumen Prosedur Mutu </h4>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form method="POST" action="{{ route('prosedurmutu.store') }}">
                         @csrf
					  <div class="row">
						<div class="col-12">
							<div class="form-group">
								<h5>Jenis Dokumen</h5>
								<div class="controls">
									<input type="text" name="doctype" class="form-control" required data-validation-required-message="This field is required" value="Prosedu Mutu" disabled="true">
                                </div>
							</div>
							<div class="form-group">
								<h5>Nomor Dokumen</h5>

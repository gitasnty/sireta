...
<div class="content-wrapper">
                            ...
                            <tr>
								...
								<td>
                                    <div class="d-flex justify-content-center">
                                        @if($document->file_path != null)
                                            <a href="{{ route('lainlain.download', $document) }}" type="button" class="btn btn-circle btn-info"><i class="glyphicon glyphicon-download-alt"></i></a>
                                        @else
                                            Tidak ada file
                                        @endif
                                    </div>
								...
								<td>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a href="{{ route('lainlain.delete', $document->id) }}" type="button" class="btn btn-circle btn-danger" id="delete"><i class="fa fa-trash"></i></a>
   ...
   <div class="modal fade" id="{{ 'uploadDoc-'.$d->id  }}" tabindex="-1" aria-labelledby="uploadDoclabel" aria-hidden="true">
    ...
    <form method="post" enctype="multipart/form-data" action="{{ route('lainlain.upload') }}">
        @csrf
